...
ax1.set_xlim3d([0.0,150.0])
ax1.set_xlabel("X")

ax1.set_ylim3d([0.0,150.0])
ax1.set_ylabel("Y")

ax1.set_zlim3d([0.0,150.0])
ax1.set_zlabel("Z")
...
#destpoint = [ax1.plot(destination[k]["x"],destination[k]["y"],destination[k]["z"], linestyle = "", marker = "x")[0] for k in destination]
